...
def decrypt():
    ...
    load = Image.open("C:/Users/Faith Chela/Desktop/bird.jpg.jpg")
...
decryption_key=28522
input=int(input("enter decryption key:"))
if input == decryption_key:
    print("correct")
else:
    print("cannot decrypt the image,wrong decryption key")
